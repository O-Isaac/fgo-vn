...
style navigation_button:
    ...
    background Image("gui/bg_btn_main_menu.png", xalign=0.5, yalign=0.5)
    hover_xpos 10
    hover_background Image("gui/s_bg_btn_main_menu.png", xalign=0.5, yalign=0.5)
    hover_mouse "pointer"
